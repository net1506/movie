...
class TheaterQueryTest {
    ...
    class GetTheatersByIdsTest {
        ...
        public void shouldThrowExceptionWhenTheaterIdsIsNull() {
            ...
            CoreException coreException = Assertions.assertThrows(CoreException.class, () ->
                    new TheaterQuery.GetTheatersByIds(theaterIds));
        ...
        public void shouldCreateGetTheatersByIds() {
            ...
            // when
            TheaterQuery.GetTheatersByIds query = new TheaterQuery.GetTheatersByIds(theaterIds);
    ...
    class GetDistinctTheaterIdsByMovieIdTest {
        @Test
        ...
        public void shouldThrowExceptionWhenMovieIdIsNull() {
            ...
            // when
            CoreException coreException = Assertions.assertThrows(CoreException.class, () ->
                    new TheaterQuery.GetDistinctTheaterIdsByMovieId(movieId));
        ...
        public void shouldCreateGetDistinctTheaterIdsByMovieId() {
            ...
            // when
            TheaterQuery.GetDistinctTheaterIdsByMovieId query = new TheaterQuery.GetDistinctTheaterIdsByMovieId(movieId);
