...
class UserQueryTest {
    ...
    class GetUserWalletByUserIdQueryTest {
        ...
        public void shouldThrowExceptionWhenIdIsNull() throws Exception {
            ...
            // when
            CoreException coreException = Assertions.assertThrows(CoreException.class, () -> new GetUserWalletByUserIdQuery(userId));
        ...
        public void shouldGetUserWalletByIdQuery() throws Exception {
            ...
            // when
            GetUserWalletByUserIdQuery getUserWalletByUserIdQuery = new GetUserWalletByUserIdQuery(userId);

            // then
            assertThat(getUserWalletByUserIdQuery.userId()).isEqualTo(userId);
        }
    }
}